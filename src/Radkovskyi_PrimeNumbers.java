...
public class Radkovskyi_PrimeNumbers extends JFrame {
    ...
    public static final int[] CONST_SEEDS = {983, 991, 997, 1009, 1013};
    // Стандартна ширина вікна.
    public static final int DEFAULT_WIDTH = 700;
    // Стандартна висота.
    public static final int DEFAULT_HEIGHT = 600;
    // Шрифт для заголовків - жирний.  Dialog - щоб на різних платформах виглядало однаково.
    public static final Font DEFAULT_FONT_BOLD = new Font("Dialog", Font.BOLD, 14);
    // Звичайний шрифт.
    public static final Font DEFAULT_FONT_PLAIN = new Font("Dialog", Font.PLAIN, 14);
    // Відступи для компонентів.
    public static final EmptyBorder DEFAULT_MARGIN = new EmptyBorder(5, 10, 5, 10);

    // Поля вводу для меж діапазону.  Зробив final, бо змінювати їх не треба.
    public final JTextField fieldMin = new JTextField();
    public final JTextField fieldMax = new JTextField();
    // Текстова область для виведення результатів.  Теж final.
    public final JTextArea areaOutput = new JTextArea();
    // Кнопка "Обчислити".
    public final JButton buttonAction = new JButton("Обчислити");
    // Підписи для полів і результатів.  Теж final, і тепер вони оголошені як поля класу.
    public final JLabel labelMin = new JLabel("Нижня границя:");
    public final JLabel labelMax = new JLabel("Верхня границя:");
    public final JLabel labelResult = new JLabel("Результати:");
    ...
    public void addComponent(JPanel panel, JComponent component, int x, int y, GridBagConstraints gbc, int anchor) {
        gbc.gridx = x;     // Колонка.
        gbc.gridy = y;     // Рядок.
    ...
    public class NumberCruncher extends SwingWorker<Void, String> {
        public final int rangeStart; // Початкове значення діапазону.
        public final int rangeEnd;   // Кінцеве значення діапазону.
        public long productPrime;    // Добуток простих чисел у діапазоні.
